            ...
            while ($data = mysqli_fetch_assoc($query)) { ?>
                <tr>
                    ...
                    <td width="120" class="center">
                        <a title="Ubah" class="btn btn-outline-info" href="proses_hapus.php?nis=<?php echo $data['nis'];?>"onclick="return confirm('Anda yakin ingin menghapus siswa <?php echo $data['nama']; ?>?');"><i class="fas fa-trash"></i></a>
                    </td>
                    </tr>
            <?php
                $no++;
