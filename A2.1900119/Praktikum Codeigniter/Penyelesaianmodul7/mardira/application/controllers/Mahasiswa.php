...
class Mahasiswa extends CI_Controller
{
    ...
    {
        $attr_nim = array(
            'required' => 'NIM harus diisii !',
            'min_length' => 'NIM minimal 8 karakter!',
            'max_length' => 'NIM melebihi 8 karakter!',
            'numeric' => 'NIM tidak menggunakan huruf!'
        );
        $attr_nama = array(
            'required' => 'Nama mahasiswa harus diisii !',
            'min_length' => 'Nama mahasiswa minimal 8 karakter!',
        ...
        $this->form_validation->set_rules('nama_mhs','Nama Mahasiswa','trim|required|min_length[5]|max_length[30]', $attr_nim);
    }
