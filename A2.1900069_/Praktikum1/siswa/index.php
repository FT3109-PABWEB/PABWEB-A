...
<html lang="en">    
    <head>
        <!-- Required meta tags -->
            ...
            <meta name="author" content="vildanvinanda">
    ...
    <body>
        <div class="container-fluid">
            <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-whiteborder-bottom shadow-sm">
                ...
                <i class="fas fa-user title-icon">
                </i> Data Siswa</h5>
            </div>
        </div>
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                       Ferry Yoga Perkasa &copy; 2021 - <a class="text-info" href="https://stmik-sumedang.ac.id/">❤STMIK Sumedang</a>
                    </div>
                </div>
            </footer>
        </div>
